...
/* Initialize stored gene */
	...
	sprintf(filename,"log_%d_%d_%d_%1.2f",PopulationSize,Generations,NumReplaced,MutationRate);
	pFile = fopen(filename,"w");
	sprintf(filename1,"stats_%d_%d_%d_%1.2f",PopulationSize,Generations,NumReplaced,MutationRate);
