  ...
  coeff_SetCurrentDiffusion (double val)
{
  ...
  {
    current_coefficient.diffusion = (int) val;
    saved_coefficient.diffusion = (int) val;
  }
}
  ...
  coeff_SetCurrentSpread (double val)
{
  ...
  {
    current_coefficient.spread = (int) val;
    saved_coefficient.spread = (int) val;
  }
}
/******************************************************************************
*******************************************************************************
  ...
  coeff_SetCurrentBreed (double val)
{
  ...
  {
    current_coefficient.breed = (int) val;
    saved_coefficient.breed = (int) val;
  }
}
  ...
  coeff_SetCurrentSlopeResist (double val)
{
  ...
  {
    current_coefficient.slope_resistance = (int) val;
    saved_coefficient.slope_resistance = (int) val;
  }
}
  ...
  coeff_SetCurrentRoadGravity (double val)
{
  ...
  {
    current_coefficient.road_gravity = (int) val;
    saved_coefficient.road_gravity = (int) val;
  }
}
